...
export interface Note {
  ...
  file_type: 'pdf' | 'markdown' | 'txt' | null;
...
export interface SoftwareProject {
  id: string; title_en: string; title_zh: string; desc_en: string; desc_zh: string;
  is_open_source: number | boolean; github_url: string | null; download_url: string | null;
  preview_key: string | null; tags: string;
  created_at: string; updated_at: string;
}

export interface TimelineItem {
  id: string; year: string; title_en: string; title_zh: string; desc_en: string; desc_zh: string; sort_order: number;
}
...
export interface Summary {
  ...
  software: { count: number; updated_at: string | null };
