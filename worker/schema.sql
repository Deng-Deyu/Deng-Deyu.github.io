-- ============================================================
--  Turtlelet D1 Schema v2
--  运行: wrangler d1 execute turtlelet-db --file=worker/schema.sql
-- ============================================================
...
CREATE TABLE IF NOT EXISTS scores (
  ...
  score_type TEXT NOT NULL DEFAULT 'mixed',
...
INSERT OR IGNORE INTO note_categories (id,name_en,name_zh,icon,sort_order) VALUES
  ('mathematics','Mathematics','数学','📐',0),
  ('engineering','Engineering','工程','⚙️',1),
  ('cs','CS / Code','计算机','💻',2),
  ('physics','Physics','物理','⚛️',3),
  ('chemistry','Chemistry','化学','🧪',4),
  ('other','Other','其他','📄',5);